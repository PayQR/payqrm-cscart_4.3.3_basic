...
//подключение функционала cs-cart
define('AREA', 'C');
require 'cscart_init.php';
...
try{
    ...
    $payqr_user_data = json_decode($Payqr->objectOrder->data->orderGroup);
    if (!is_array($payqr_user_data)) $payqr_user_data = fn_objectToArray($payqr_user_data);
